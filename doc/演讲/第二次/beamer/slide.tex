    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \begin{block}{全系统数据流}
                ...
                \includegraphics[height=0.7\textheight]{data_flow.png}
            \end{block}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{block}{语音转换流水线}
...
\begin{block}{配置数据流设计}
\centering
% 注意：请将Mermaid图转换为名为 copywriting_flow.png 的图片文件
\includegraphics[width=0.8\textwidth]{copywriting_flow.png}
\end{block}
