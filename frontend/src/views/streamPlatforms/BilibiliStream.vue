    ...
    <div class="page-container">
        <div class="container">
            ...
            <div v-if="currentTab === 'account'" class="tab-content">
                ...
                <div class="section">
                    <h2>{{ $t('bilibili.account.manualInput') }}</h2>
                    <div class="form-group">
                        <label>{{ $t('bilibili.account.roomId') }}</label>
                        <input type="password" v-model="accountInfo.room_id" :placeholder="$t('bilibili.account.roomIdPlaceholder')" />
                    </div>

                    <div class="form-group">
                        <label>{{ $t('bilibili.account.cookies') }}</label>
                        <input type="password" v-model="accountInfo.cookie_str" :placeholder="$t('bilibili.account.cookiesPlaceholder')" />
                    </div>

                    <div class="form-group">
                        <label>{{ $t('bilibili.account.csrfToken') }}</label>
                        <input type="password" v-model="accountInfo.csrf" :placeholder="$t('bilibili.account.csrfTokenPlaceholder')" />
                    </div>
            ...
            <div v-if="currentTab === 'live'" class="tab-content">
                <div class="section">
                    <h2>{{ $t('bilibili.live.title') }}</h2>
                    <div class="form-row">
                        <label for="live-title">{{ $t('bilibili.live.titleInput') }}</label>
                        <input id="live-title" type="text" v-model="liveSettings.live_title" class="title-input" :placeholder="$t('bilibili.live.titlePlaceholder')" />
                ...
                <div class="section">
                    <h2>{{ $t('bilibili.live.area') }}</h2>
                    <div class="form-row">
                        <label for="main-area">{{ $t('bilibili.live.selectArea') }}</label>
                        <select id="main-area" v-model="liveSettings.selected_area" @change="updateSubPartitions" class="model-select">
                            <option value="">{{ $t('bilibili.live.selectArea') }}</option>
                            <option v-for="area in mainAreas" :key="area" :value="area">{{ area }}</option>
                        </select>
                        <label for="sub-area" style="margin-left:24px;">{{ $t('bilibili.live.selectSubArea') }}</label>
                        <select id="sub-area" v-model="liveSettings.selected_sub_area" class="model-select">
                            <option value="">{{ $t('bilibili.live.selectSubArea') }}</option>
                ...
                <div class="section">
                    <h2>{{ $t('bilibili.live.sendBullet') }}</h2>
                    <div class="form-row">
                        <label for="bullet-input">{{ $t('bilibili.live.bulletInput') }}</label>
                        <input id="bullet-input" type="text" v-model="bulletMessage" class="bullet-input" :placeholder="$t('bilibili.live.bulletPlaceholder')" />
                ...
                <div class="section">
                    <h2>{{ $t('bilibili.live.operationLog') }}</h2>
                    <div class="log-area">
        ...
        <el-dialog v-model="showHelpDialog" :title="$t('bilibili.help.title')" width="640px" class="help-dialog" :lock-scroll="false" :auto-focus="false">
...
.bilibili-logo:hover {
    ...
    filter: drop-shadow(0 4px 8px rgba(251, 114, 153, 0.4));
}
