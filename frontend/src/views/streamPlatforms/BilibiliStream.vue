    ...
    <div class="page-container">
        <div class="container">
            <div class="header-section">
                <h1 class="main-title">
                    <svg class="bilibili-logo" xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="2240" height="1024" viewBox="0 0 2240 1024">
                        <path
            ...
            <div v-if="currentTab === 'live'" class="tab-content">
                ...
                <div class="section">
                    ...
                    <div class="form-row">
                        ...
                        <select id="main-area" v-model="liveSettings.selected_area" @change="updateSubPartitions"
                            class="model-select">
